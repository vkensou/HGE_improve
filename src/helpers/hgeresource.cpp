...
hgeResourceManager::hgeResourceManager(const wchar_t *scriptname)
{
...
void hgeResourceManager::_parse_script(const wchar_t *scriptname)
{
	ResDesc *rc, *rcnext;
...
void hgeResourceManager::ChangeScript(const wchar_t *scriptname)
{
	_remove_all();
	_parse_script(scriptname);
}
...
void* hgeResourceManager::GetResource(const wchar_t *name)
{
	void *reshandle;
	RResource *resource;
...
HTEXTURE hgeResourceManager::GetTexture(const wchar_t *name)
{
	HTEXTURE reshandle;
	RTexture *resource;
...
HEFFECT hgeResourceManager::GetEffect(const wchar_t *name)
{
	HEFFECT reshandle;
	REffect *resource;
...
HMUSIC hgeResourceManager::GetMusic(const wchar_t *name)
{
	HMUSIC reshandle;
	RMusic *resource;
...
HSTREAM hgeResourceManager::GetStream(const wchar_t *name)
{
	HSTREAM reshandle;
	RStream *resource;
...
HTARGET hgeResourceManager::GetTarget(const wchar_t *name)
{
...
hgeSprite* hgeResourceManager::GetSprite(const wchar_t *name)
{
...
hgeAnimation* hgeResourceManager::GetAnimation(const wchar_t *name)
{
...
hgeFont* hgeResourceManager::GetFont(const wchar_t *name)
{
...
hgeParticleSystem* hgeResourceManager::GetParticleSystem(const wchar_t *name)
{
...
hgeDistortionMesh* hgeResourceManager::GetDistortionMesh(const wchar_t *name)
{
...
hgeStringTable* hgeResourceManager::GetStringTable(const wchar_t *name)
{
