...
{
	static  void  Parse(hgeResourceManager *rm, RScriptParser *sp, const wchar_t *name, const wchar_t *basename);
...
{
	wchar_t		filename[MAXRESCHARS];
	wchar_t		spritename[MAXRESCHARS];
